from Project.Neural_Net import neural_net
...
result = pd.read_csv(filename_2, names=colnames_2, sep=',', header=1)
...
# run neural network
model = neural_net.nn(modelname_2, dense_2, result, epochs)
